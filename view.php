...
<div id="unlockDialog" class="dialog">
  <div class="dialog-box">
    ...
    <input id="unlockCodeInput" class="name-in" style="width:100%;text-transform:uppercase;letter-spacing:3px;text-align:center;font-size:16px" placeholder="投稿碼" autocomplete="off" inputmode="text" aria-label="投稿碼">
