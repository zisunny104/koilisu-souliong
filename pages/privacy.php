...
<style>
:root{color-scheme:light dark;--bg:#fafafa;--fg:#1b1b1d;--muted:#6b6b70;--line:#e7e7ea;--card:#fff;--accent:#1b1b1d;--r:1.25rem}
@media(prefers-color-scheme:dark){:root{--bg:#141416;--fg:#f1f1f3;--muted:#9c9ca3;--line:#2e2e31;--card:#1d1d20;--accent:#f1f1f3}}
:root[data-theme=light]{--bg:#fafafa;--fg:#1b1b1d;--muted:#6b6b70;--line:#e7e7ea;--card:#fff;--accent:#1b1b1d}
:root[data-theme=dark]{--bg:#141416;--fg:#f1f1f3;--muted:#9c9ca3;--line:#2e2e31;--card:#1d1d20;--accent:#f1f1f3}
*{box-sizing:border-box}
body{margin:0;font-family:system-ui,sans-serif;background:var(--bg);color:var(--fg);line-height:1.75;-webkit-font-smoothing:antialiased}
.wrap{max-width:44rem;margin:0 auto;padding:2.5rem 1.25rem 4rem}
a{color:inherit}
h1{font-size:1.6rem;font-weight:800;margin:0 0 .25rem}
.lead{color:var(--muted);font-size:.95rem;margin:0 0 1.75rem}
h2{font-size:1.15rem;font-weight:800;margin:2rem 0 .5rem}
.en{color:var(--muted);font-size:.9rem}
ul{margin:.4rem 0 0;padding-left:1.2rem}
li{margin:.3rem 0}
.card{background:var(--card);border:1px solid var(--line);border-radius:var(--r);padding:1.1rem 1.3rem;margin-top:.75rem}
.back{display:inline-block;margin-bottom:1.5rem;font-size:.9rem;color:var(--muted);text-decoration:none}
code{font-family:ui-monospace,Consolas,monospace;font-size:.85em;background:var(--line);padding:.1em .35em;border-radius:.3em}
...
<div class="card">
以瀏覽器 <code>localStorage</code> 保存（僅在你的裝置、可自行清除）：
<ul>
...
<ul>
  ...
  <li><b>防冒名的來源標記</b>：為了在發生冒名或濫用時界定影響範圍，系統會保存一段<b>加鹽雜湊</b>後的來源標記。它經過去識別、無法還原成 IP，僅供管理者鑑識，<b>不對外顯示</b>。<span class="en">— a salted, de-identified source hash for abuse forensics; never shown publicly and not reversible to an IP.</span></li>
</ul>
</div>
